...
//---------------------------------------------------------------------------
void vtkMRMLRTIhepIonBeamNode::CreateBeamPolyData(vtkPolyData* beamModelPolyData/*=nullptr*/)
{
...
//---------------------------------------------------------------------------
bool vtkMRMLRTIhepIonBeamNode::CreateMlcBoundaryPositionVector(bool typeMLCX,
...
//---------------------------------------------------------------------------
bool vtkMRMLRTIhepIonBeamNode::CreateMlcBoundaryVector(bool typeMLCX,
  double isocenterToMlcDistance,
