...
#ifndef __qSlicerRtImageModuleWidget_h
#define __qSlicerRtImageModuleWidget_h
...
class qSlicerRtImageModuleWidgetPrivate;
class vtkMRMLNode;

/// \ingroup Slicer_QtModules_ExtensionTemplate
class Q_SLICER_QTMODULES_RTIMAGE_EXPORT qSlicerRtImageModuleWidget :
...
public:
  ...
  qSlicerRtImageModuleWidget(QWidget *parent=0);
  virtual ~qSlicerRtImageModuleWidget();
...
private:
  ...
  Q_DISABLE_COPY(qSlicerRtImageModuleWidget);
};
