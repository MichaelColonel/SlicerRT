...
const char* vtkSlicerRtImageLogic::RTIMAGE_TRANSFORM_NODE_NAME = "RtImageTransform";
...
//----------------------------------------------------------------------------
void vtkSlicerRtImageLogic::CreateMarkupsNodes(vtkMRMLRTImageNode* parameterNode)
{
  vtkMRMLScene* scene = this->GetMRMLScene(); 
  if (!scene)
  {
  ...
  if (beamNode)
  {
    transformNode = this->UpdateRtImageTransformFromBeam(beamNode);
  }
...
//----------------------------------------------------------------------------
void vtkSlicerRtImageLogic::UpdateMarkupsNodes(vtkMRMLRTImageNode* parameterNode)
{
  vtkMRMLScene* scene = this->GetMRMLScene(); 
  if (!scene)
  {
  ...
  vtkMRMLTransformNode* transformNode = this->UpdateRtImageTransformFromBeam(beamNode);
...
//----------------------------------------------------------------------------
vtkMRMLMarkupsClosedCurveNode* vtkSlicerRtImageLogic::CreateImagerBoundary(vtkMRMLRTImageNode* parameterNode)
{
...
//----------------------------------------------------------------------------
vtkMRMLMarkupsClosedCurveNode* vtkSlicerRtImageLogic::CreateImageWindow(vtkMRMLRTImageNode* parameterNode)
{
...
//----------------------------------------------------------------------------
vtkMRMLMarkupsLineNode* vtkSlicerRtImageLogic::CreateImagerNormal(vtkMRMLRTImageNode* parameterNode)
{
...
//----------------------------------------------------------------------------
vtkMRMLMarkupsLineNode* vtkSlicerRtImageLogic::CreateImagerVUP(vtkMRMLRTImageNode* parameterNode)
{
  vtkNew<vtkMRMLMarkupsLineNode> vectorMarkupsNode;
  this->GetMRMLScene()->AddNode(vectorMarkupsNode);
...
//----------------------------------------------------------------------------
vtkMRMLMarkupsFiducialNode* vtkSlicerRtImageLogic::CreateFiducials(vtkMRMLRTImageNode* parameterNode)
{
...
//------------------------------------------------------------------------------
vtkMRMLLinearTransformNode* vtkSlicerRtImageLogic::UpdateRtImageTransformFromBeam(vtkMRMLRTBeamNode* beamNode)
{
  if (!beamNode)
  {
    vtkErrorMacro("UpdateRtImageTransformFromBeam: Invalid beam node");
    return nullptr;
  }
  vtkMRMLScene* scene = this->GetMRMLScene();
  if (!scene)
  {
    vtkErrorMacro("UpdateRtImageTransformFromBeam: Invalid MRML scene");
    return nullptr;
  }
    ...
    vtkSlicerIECTransformLogic::CoordinateSystemIdentifier::RAS, generalTransform))
  {
    ...
    {
      vtkErrorMacro("UpdateRtImageTransformFromBeam: Unable to set transform with non-linear components to beam " << beamNode->GetName());
      return nullptr;
    }
...
//------------------------------------------------------------------------------
void vtkSlicerRtImageLogic::UpdateNormalAndVupVectors(vtkMRMLRTImageNode* parameterNode)
{
  if (!parameterNode)
  {
...
//------------------------------------------------------------------------------
void vtkSlicerRtImageLogic::SetBeamsLogic(vtkSlicerBeamsModuleLogic* beamsLogic)
{
