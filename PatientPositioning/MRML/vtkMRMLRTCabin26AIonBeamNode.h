...
#ifndef __vtkMRMLRTCabin26AIonBeamNode_h
#define __vtkMRMLRTCabin26AIonBeamNode_h
...
class VTK_SLICER_PATIENTPOSITIONING_MODULE_MRML_EXPORT vtkMRMLRTCabin26AIonBeamNode : public vtkMRMLRTFixedIonBeamNode
{

public:
  static vtkMRMLRTCabin26AIonBeamNode *New();
  vtkTypeMacro(vtkMRMLRTCabin26AIonBeamNode,vtkMRMLRTFixedIonBeamNode);
  ...
  const char* GetNodeTagName() override { return "RTCabin26AIonBeamNode"; };
...
protected:
  vtkMRMLRTCabin26AIonBeamNode();
  ~vtkMRMLRTCabin26AIonBeamNode() override;
  vtkMRMLRTCabin26AIonBeamNode(const vtkMRMLRTCabin26AIonBeamNode&);
  void operator=(const vtkMRMLRTCabin26AIonBeamNode&);
...
#endif // __vtkMRMLRTCabin26AIonBeamNode_h
