...
//------------------------------------------------------------------------------
vtkMRMLNodeNewMacro(vtkMRMLRTChannel25IonBeamNode);

//----------------------------------------------------------------------------
vtkMRMLRTChannel25IonBeamNode::vtkMRMLRTChannel25IonBeamNode()
  :
  Superclass(),
...
//----------------------------------------------------------------------------
void vtkMRMLRTChannel25IonBeamNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkMRMLRTChannel25IonBeamNode::ReadXMLAttributes(const char** atts)
{
...
void vtkMRMLRTChannel25IonBeamNode::Copy(vtkMRMLNode *anode)
{
  ...
  vtkMRMLRTChannel25IonBeamNode* node = vtkMRMLRTChannel25IonBeamNode::SafeDownCast(anode);
  if (!node)
  {
    return;
  }
...
//----------------------------------------------------------------------------
void vtkMRMLRTChannel25IonBeamNode::CopyContent(vtkMRMLNode *anode, bool deepCopy/*=true*/)
{
...
//----------------------------------------------------------------------------
void vtkMRMLRTChannel25IonBeamNode::SetScene(vtkMRMLScene* scene)
{
  Superclass::SetScene(scene);
}

//----------------------------------------------------------------------------
void vtkMRMLRTChannel25IonBeamNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkMRMLRTChannel25IonBeamNode::SetIsocenterToMlcLayer1Distance(double distance)
{
...
//----------------------------------------------------------------------------
void vtkMRMLRTChannel25IonBeamNode::SetIsocenterToMlcLayer2Distance(double distance)
{
...
//---------------------------------------------------------------------------
void vtkMRMLRTChannel25IonBeamNode::CreateBeamPolyData(vtkPolyData* beamModelPolyData/*=nullptr*/)
{
...
//---------------------------------------------------------------------------
bool vtkMRMLRTChannel25IonBeamNode::CreateMlcBoundaryPositionVector(bool typeMLCX,
...
//---------------------------------------------------------------------------
bool vtkMRMLRTChannel25IonBeamNode::CreateMlcBoundaryVector(bool typeMLCX,
  double isocenterToMlcDistance,
